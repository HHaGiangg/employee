...
<head>
    ...
    <link rel="shortcut icon" href="{{{ asset('theme_admin/assets/media/favicons/favicon.png')}}}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('theme_admin/assets/media/favicons/favicon-192x192.png')}}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('theme_admin/assets/media/favicons/apple-touch-icon-180x180.png')}}">
    <!-- END Icons -->
    <!--jquery-confirm -->
    ...
    <link rel="stylesheet" id="css-main" href="{{ asset('theme_admin/assets/css/oneui.min.css')}}">
...
<div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
    ...
    <aside id="side-overlay">
        ...
        <div class="content-header border-bottom">
            ...
            <a class="img-link mr-1" href="javascript:void(0)">
                <img class="img-avatar img-avatar32" src="{{ asset('theme_admin/assets/media/avatars/avatar10.jpg')}}" alt="">
            </a>
            <!-- END User Avatar -->
                            ...
                            <div class="block-content">
                                ...
                                <ul class="nav-items mb-0">
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48" src="{{ asset('theme_admin/assets/media/avatars/avatar6.jpg')}}" alt="">
                                    ...
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48" src="{{ asset('theme_admin/assets/media/avatars/avatar11.jpg')}}" alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48" src="{{ asset('theme_admin/assets/media/avatars/avatar1.jpg')}}" alt="">
                                    ...
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48" src="{{ asset('theme_admin/assets/media/avatars/avatar10.jpg')}}" alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                            </div>
                                            <div class="media-body">
    ...
    <!-- Sidebar -->
    <!--
        Sidebar Mini Mode - Display Helpers classes
            ...
            <div class="content-side">
                <ul class="nav-main">
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="{{ route('admin.get.dashboard') }}">
                    ...
                    <li class="nav-main-item open">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                            ...
                            <span class="nav-main-link-name">Quản lý phòng ban</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="{{ route('admin.get.list.department') }}">
                                    <span class="nav-main-link-name">Phòng ban</span>
                                </a>
                                <a class="nav-main-link active" href="{{ route('admin.get.list.position') }}">
                                    <span class="nav-main-link-name">Vị trí nhân viên</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-main-item open">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                            ...
                            <span class="nav-main-link-name">Quản lý nhân viên</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="{{ route('admin.get.list.employee') }}">
                                    <span class="nav-main-link-name">Nhân viên</span>
                                </a>
                                <a class="nav-main-link active" href="{{ route('admin.get.list.form') }}">
                                    <span class="nav-main-link-name">Đơn xin nghỉ </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-main-item open">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                            ...
                            <span class="nav-main-link-name">Quản lý chỉ tiêu</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link active" href="{{ route('admin.get.list.target_department') }}">
                                    <span class="nav-main-link-name">Chỉ tiêu phòng ban </span>
                                </a>
                                <a class="nav-main-link active" href="{{ route('admin.get.list.target_employee') }}">
                                    <span class="nav-main-link-name">Chỉ tiêu nhân viên </span>
                                </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown d-inline-block ml-2">
                    <button type="button" class="btn btn-sm btn-dual d-flex align-items-center" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle" src="{{ asset('theme_admin/assets/media/avatars/avatar10.jpg')}}" alt="Header Avatar" style="width: 21px;">
                        <span class="d-none d-sm-inline-block ml-2">Adam</span>
                        <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block ml-1 mt-1"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                        <div class="p-3 text-center bg-primary-dark rounded-top">
                            <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ asset('theme_admin/assets/media/avatars/avatar10.jpg')}}" alt="">
                ...
                <div class="dropdown d-inline-block ml-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-notifications-dropdown">
                        <div class="p-2 bg-primary-dark text-center rounded-top">
                            <h5 class="dropdown-header text-uppercase text-white">Admin Page</h5>
                        </div>
                        <ul class="nav-items mb-0">
                            <li>
                                <a class="text-dark media py-2" href="javascript:void(0)">
...
-->
<script src="{{ asset('theme_admin/assets/js/oneui.core.min.js')}}"></script>
...
-->
<script src="{{ asset('theme_admin/assets/js/oneui.app.min.js')}}"></script>

<!-- Page JS Plugins -->
<script src="{{ asset('theme_admin/assets/js/plugins/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".js-preview-employee").click(function(event){
            ...
            $.ajax({
                ...
                $("#modal-block-large .col-xl-20").html(results.html);
