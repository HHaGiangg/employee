                ...
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            ...
                            <li class="breadcrumb-item">Chỉ tiêu</li>
            ...
            <div class="col-lg-8 col-xl-5">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="department_id" class="form-control ">
                            ...
                            @foreach($departments as $department)
                                <option value="{{ $department->id }}" {{ old('department_id',$target->department_id ?? 0) == $department->id ? "selected" : "" }}>{{ $department->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="name" value="{{ $target->name }}" placeholder="Name"  required="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control"  name="description"  rows="5"  placeholder="What would you like to see?">{{ $target->description }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="point" value="{{ $target->point }}" placeholder="Title" required="">
